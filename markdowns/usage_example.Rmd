...
```{r forecast}
res_fore <- suppressWarnings(dbnR::forecast_ts(f_dt_val, fit, size, obj_vars = c("pm_t_0", "stator_winding_t_0"), ini = 100, len = 70))
set.seed(42)
res_fore <- suppressWarnings(dbnR::forecast_ts(f_dt_val, fit, size, obj_vars = c("pm_t_0"), ini = 100, len = 70, mode = "approx", num_p = 150, rep = 3))
```
...
```{r forecast_ev_1}
res_fore <- suppressWarnings(dbnR::forecast_ts(f_dt_val, fit, size, obj_vars = c("pm_t_0"), ini = 100, len = 70, prov_ev = c("stator_winding_t_0", "u_q_t_0")))
```
...
res_fore <- suppressWarnings(dbnR::forecast_ts(inter_dt, fit, size, obj_vars = c("pm_t_0"), ini = 100, len = 70, prov_ev = c("stator_winding_t_0", "u_q_t_0")))
```
...
```{r smoothing}
res_smooth <- suppressWarnings(dbnR::smooth_ts(f_dt_val, fit, size, obj_vars = c("stator_winding_t_2"), ini = 70, len = 20))
```
